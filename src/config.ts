...
// Memory
export const GLOBAL_MEMORY_PATH = path.join(
  REPO_ROOT,
  "contexts",
  "global",
  "memory.md",
...
export const SESSION_LOG_DIR = path.join(
  REPO_ROOT,
  "contexts",
  "personal",
  "memory",
...
export const env = {
  ...
  QUIET_HOURS_START: parseInt(process.env["QUIET_HOURS_START"] ?? "21", 10),
  QUIET_HOURS_END: parseInt(process.env["QUIET_HOURS_END"] ?? "7", 10),
};
